                        ...
                        <table class="table table-sm text-center">
                            ...
                            <tbody>
                                <tr v-for="d, no in datas.data" >
                                    ...
                                    <td>{{ d.description }}</td>
                                    <td>{{ d.type }}</td>
                                    <td> <img :src="'img/portfolio/' + d.picture" alt="" class="img-responsive"> </td>
                                    <td>
            ...
            <div class="box-body">
                <div class="form-group">
                    <div class="row">
                        ...
                        <div class="col-md-9">
                            <input type="text" v-model='input.type' class="form-control">
                        </div>
                    </div>
                </div>
                <div class="form-group">
                    <div class="row">
                        ...
                        <div class="col-md-9">
                            <input type="text" v-model='input.name_produk' class="form-control">
                        </div>
                    </div>
                </div>
                <div class="form-group">
                    <div class="row">
                        ...
                        <div class="col-md-9">
                            <input type="text" v-model="input.description" class="form-control">
                        </div>
                    </div>
                </div>
                <div class="form-group">
...
export default {
    ...
    methods:{
        ...
        save(){
            axios.post(this.url ,{ image: this.image, name_produk : this.input.name_produk , description : this.input.description, type :this.input.type }).then((res) => {
                this.input.name = ''
                this.input.description = ''
                this.input.type = ''
                this.image = null
        ...
        update(input){
            if(this.image == null){
                axios.post(BASE_URL + 'api/produk/updatedata', this.input   ).then((res) =>{
                    this.input.name = ''
                    this.input.description = ''
                    this.input.type = ''
                    this.image = null
                ...
                axios.post(BASE_URL + 'api/produk/updatedata', { image: this.image, name_produk : this.input.name_produk , description : this.input.description, type :this.input.type , id : this.input.id }).then((res) =>{
                    this.input.name = ''
                    this.input.description = ''
                    this.input.type = ''
                    this.getData(this.pages)
