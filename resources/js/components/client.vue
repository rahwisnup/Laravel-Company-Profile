                        ...
                        <table class="table table-sm text-center">
                            ...
                            <tbody>
                                <tr v-for="d, no in datas.data" >
                                    <td>{{ no + 1 }}</td>
                                    <td>{{ d.name  }}</td>
                                    <td> <img :src="'img/clients/' + d.logo" alt="" class="img-responsive"> </td>
                                    <td>
        ...
        <modal name="create" class="box" height="auto">
            ...
            <div class="box-body">
                <div class="form-group">
                    <div class="row">
                        <label class="col-md-3">Name Client</label>
                        <div class="col-md-9">
...
export default {
    ...
    methods:{
        ...
        save(){
            axios.post(this.url ,{ image: this.image, name : this.input.name }).then((res) => {
               this.input.name = ''
               this.image = null
        ...
        update(input){
            if(this.image == null){
                axios.post(BASE_URL + 'api/client/updatedata', this.input   ).then((res) =>{
                    this.input.name = ''
                    this.image = null
                ...
                axios.post( BASE_URL + 'api/client/updatedata', { image: this.image, id : this.input.id, name : this.input.name }).then((res) =>{
                    this.input.name = ''
                    this.getData(this.pages)
                    this.$modal.hide('create')
                    console.log(res)
        ...
        deleted(d){
            ...
            axios.delete(this.url+`/${d.id}?picture=${d.logo}`,  ).then((res) =>{
