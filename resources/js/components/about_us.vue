                        ...
                        <table class="table table-sm text-center">
                            ...
                            <tbody>
                                <tr v-for="d, no in datas.data" >
                                    ...
                                    <td> <img :src="'img/about/' + d.picture" alt="" class="img-responsive"> </td>
                                    <td>
...
export default {
    ...
    methods:{
        ...
        save(){
            axios.post(this.url ,{ image: this.image, title : this.input.title , icon : this.input.icon , description : this.input.description}).then((res) => {
               this.input.title = ''
               this.input.description = ''
               this.image = null
        ...
        update(input){
            if(this.image == null){
                axios.post(BASE_URL + 'api/about/updatedata', this.input   ).then((res) =>{
                    this.input.title = ''
                    this.input.description = ''
                    this.image = null
                ...
                axios.post(BASE_URL + 'api/about/updatedata', { image: this.image, icon : this.input.icon , id : this.input.id , title : this.input.title , description : this.input.description}).then((res) =>{
                    this.input.title = ''
                    this.input.content = ''
                    this.getData(this.pages)
                    this.$modal.hide('create')
